 ...
 * @brief Define the infrastructure of the DFRobot_AS7341wire1 class
 * @n Drive AS7341wire1-IC-integrated spectrum sensor  
...
#ifndef DFROBOT_AS7341wire1_H
#define DFROBOT_AS7341wire1_H
#if ARDUINO >= 100
#include "Arduino.h"
#else
#include "WProgram.h"
...
#define DBG(...)
#endif
#define REG_AS7341wire1_ASTATUS  0X60
/*
#define REG_AS7341wire1_CH0_DATA_L  0X61
#define REG_AS7341wire1_CH0_DATA_H  0X62
#define REG_AS7341wire1_ITIME_L  0X63
#define REG_AS7341wire1_ITIME_M  0X64
#define REG_AS7341wire1_ITIME_H  0X65
#define REG_AS7341wire1_CH1_DATA_L  0X66
#define REG_AS7341wire1_CH1_DATA_H  0X67

#define REG_AS7341wire1_CH2_DATA_L  0X68
#define REG_AS7341wire1_CH2_DATA_H  0X69
#define REG_AS7341wire1_CH3_DATA_L  0X6A
#define REG_AS7341wire1_CH3_DATA_H  0X6B
#define REG_AS7341wire1_CH4_DATA_L  0X6C
#define REG_AS7341wire1_CH4_DATA_H  0X6D
#define REG_AS7341wire1_CH5_DATA_L  0X6E
#define REG_AS7341wire1_CH5_DATA_H  0X6F
*/
#define REG_AS7341wire1_CONFIG      0X70
#define REG_AS7341wire1_STAT        0X71
#define REG_AS7341wire1_EDGE        0X72
#define REG_AS7341wire1_CPIO        0X73
#define REG_AS7341wire1_LED         0X74

#define REG_AS7341wire1_ENABLE      0X80
#define REG_AS7341wire1_ATIME       0X81
#define REG_AS7341wire1_WTIME       0X83

#define REG_AS7341wire1_SP_TH_L_LSB 0X84
#define REG_AS7341wire1_SP_TH_L_MSB 0X85
#define REG_AS7341wire1_SP_TH_H_LSB 0X86
#define REG_AS7341wire1_SP_TH_H_MSB 0X87
#define REG_AS7341wire1_AUXID       0X90
#define REG_AS7341wire1_REVID       0X91

#define REG_AS7341wire1_ID          0X92
#define REG_AS7341wire1_STATUS_1      0X93
#define REG_AS7341wire1_ASTATUS     0X94


#define REG_AS7341wire1_CH0_DATA_L  0X95
#define REG_AS7341wire1_CH0_DATA_H  0X96
#define REG_AS7341wire1_CH1_DATA_L  0X97
#define REG_AS7341wire1_CH1_DATA_H  0X98
#define REG_AS7341wire1_CH2_DATA_L  0X99
#define REG_AS7341wire1_CH2_DATA_H  0X9A
#define REG_AS7341wire1_CH3_DATA_L  0X9B
#define REG_AS7341wire1_CH3_DATA_H  0X9C
#define REG_AS7341wire1_CH4_DATA_L  0X9D
#define REG_AS7341wire1_CH4_DATA_H  0X9E
#define REG_AS7341wire1_CH5_DATA_L  0X9F
#define REG_AS7341wire1_CH5_DATA_H  0XA0

#define REG_AS7341wire1_STATUS_2    0XA3
#define REG_AS7341wire1_STATUS_3    0XA4
#define REG_AS7341wire1_STATUS_5    0XA6
#define REG_AS7341wire1_STATUS_6    0XA7
#define REG_AS7341wire1_CFG_0       0XA9
#define REG_AS7341wire1_CFG_1       0XAA
#define REG_AS7341wire1_CFG_3       0XAC
#define REG_AS7341wire1_CFG_6       0XAF
#define REG_AS7341wire1_CFG_8       0XB1
#define REG_AS7341wire1_CFG_9       0XB2
#define REG_AS7341wire1_CFG_10      0XB3
#define REG_AS7341wire1_CFG_12      0XB5


#define REG_AS7341wire1_PERS          0XBD
#define REG_AS7341wire1_GPIO_2        0XBE
#define REG_AS7341wire1_ASTEP_L       0XCA
#define REG_AS7341wire1_ASTEP_H       0XCB
#define REG_AS7341wire1_AGC_GAIN_MAX  0XCF
#define REG_AS7341wire1_AZ_CONFIG     0XD6
#define REG_AS7341wire1_FD_TIME_1     0XD8
#define REG_AS7341wire1_TIME_2        0XDA
#define REG_AS7341wire1_CFG0          0XD7
#define REG_AS7341wire1_STATUS        0XDB
#define REG_AS7341wire1_INTENAB       0XF9
#define REG_AS7341wire1_CONTROL       0XFA
#define REG_AS7341wire1_FIFO_MAP      0XFC
#define REG_AS7341wire1_FIFO_LVL      0XFD
#define REG_AS7341wire1_FDATA_L       0XFE
#define REG_AS7341wire1_FDATA_H       0XFF


#define AS7341wire1_GPIO               4

class DFRobot_AS7341wire1 
{
public:
...
#define ERR_IC_VERSION    -2      //Chip version mismatch 
  ...
  */
   ...
   * @param pWire1 IC bus pointer object and construction device, can both pass or not pass parameters, Wire in default.
   */
  DFRobot_AS7341wire1(TwoWire *pWire1 = &Wire1); 
...
private:
  ...
  void enableAS7341wire1(bool on);
